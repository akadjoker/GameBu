/*
 *  DIV/Bennu File Loader for Raylib
 *  Adapted to use Raylib instead of SDL
 *
 *  Original Copyright (C) SplinterGU (Fenix/BennuGD) (Since 2006)
 *  Original Copyright (C) 2002-2006 Fenix Team (Fenix)
 *  Original Copyright (C) 1999-2002 José Luis Cebrián Pagüe (Fenix)
 *
 *  Raylib Adaptation (C) 2026
 */
